...
class LiiveLocation extends StatefulWidget {
  final logistictransection loc;

  LiiveLocation({required this.loc});

  @override
  State<LiiveLocation> createState() => _LiiveLocationState();
}

class _LiiveLocationState extends State<LiiveLocation> {
  String? _mapStyle;
  ...
  void initState() {
    ...
    markers.add(Marker(
      markerId:  MarkerId('Farmer Location'),
    ...
    markers.add(Marker(
        markerId:  MarkerId('Buyer Location'),
        infoWindow: InfoWindow(
  ...
  camera_position() async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(
        CameraPosition(target: farmerlocation, zoom: 7.5)));
  }
